...
document.writeln('<div class="panel panel-success">' + '<div class="panel-heading">' + '<h1 class="panel-title">'+ 'Klant naam: ' + naam + '</h1>' + '</div>' + '<div class="panel-body">' +"<br><br>");
...
document.writeln('<br>' + '<footer>Project Helpdesk Javascript - Versie 0.5</footer>');
